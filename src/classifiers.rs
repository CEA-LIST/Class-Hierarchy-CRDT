...
__classifiers::union!(
    ModelElement = Classifier(Classifier, ClassifierLog)
...
__classifiers::union!(Classifier = Class(Class, ClassLog) | DataType(DataType, DataTypeLog));
__classifiers::record!(ClassifierFeat {
    model_element_feat: ModelElementFeatLog,
});
__classifiers::record!(
...
__classifiers::union!(
    StructuralFeature = Attribute(Attribute, AttributeLog) | Reference(Reference, ReferenceLog)
);
__classifiers::record!(
...
__classifiers::record!(Attribute {
    structural_feature_feat: StructuralFeatureFeatLog,
});
__classifiers::record!(
...
__classifiers::record!(DataType {
    classifier_feat: ClassifierFeatLog,
});
