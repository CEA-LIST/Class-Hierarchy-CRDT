...
__classifiers::union!(
    ModelElementKind = Classifier(ClassifierKind, ClassifierKindLog) | Package(Package,
...
__classifiers::record!(
    StructuralFeature { model_element_super : ModelElementLog, lower :
...
__classifiers::record!(Attribute { structural_feature_super : StructuralFeatureLog, });
__classifiers::record!(
    Reference { structural_feature_super : StructuralFeatureLog, is_container :
    __classifiers::VecLog < __classifiers::EWFlag >, }
);
__classifiers::record!(
    Class { classifier_super : ClassifierLog, is_abstract : __classifiers::VecLog <
    __classifiers::EWFlag >, features : __classifiers::NestedListLog <
    StructuralFeatureKindLog >, }
);
__classifiers::record!(DataType { classifier_super : ClassifierLog, });
